...
def make_charts(df, ticker):
    fig = make_subplots(rows=4, cols=1, vertical_spacing=0.01, subplot_titles=(ticker,"Stochastic Oscillator","RSI","Kelner channels"), shared_xaxes=True, row_heights=[0.6, 0.1,0.1,0.6])
